function [t_uk,uk1,uk2,uk3] = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [T_UK,UK1,UK2,UK3] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [T_UK,UK1,UK2,UK3] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [t_uk,uk1,uk2,uk3] = importfile('uk_data_measurement_noise.csv',2, 4045);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/03/10 14:04:42
