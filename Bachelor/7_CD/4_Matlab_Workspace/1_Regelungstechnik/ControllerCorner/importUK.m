function [t,uk1,uk2,uk3] = importUK(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [T,UK1,UK2,UK3] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [T,UK1,UK2,UK3] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [t,uk1,uk2,uk3] = importfile('uk.csv',2, 2128);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/04/22 12:42:45
