function [t,ur1,ur2,ur3] = importUR(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [T,UR1,UR2,UR3] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [T,UR1,UR2,UR3] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [t,ur1,ur2,ur3] = importfile('ur.csv',2, 2128);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/04/22 12:43:28
