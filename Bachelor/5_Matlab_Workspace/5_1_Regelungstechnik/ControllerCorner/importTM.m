function [t,tm1,tm2,tm3] = importTM(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [T,TM1,TM2,TM3] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [T,TM1,TM2,TM3] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [t,tm1,tm2,tm3] = importfile('tm.csv',2, 2128);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/04/22 12:43:43
