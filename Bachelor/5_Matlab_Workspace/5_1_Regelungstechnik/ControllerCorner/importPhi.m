function [t,phi2,phi3] = importPhi(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [T,PHI2,PHI3] = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   [T,PHI2,PHI3] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [t,phi2,phi3] = importfile('phi.csv',2, 2128);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/04/22 12:42:26
