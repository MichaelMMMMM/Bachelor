...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CEdgeBalanceWidget_t, stringdata) + ofs \
...
const QMetaObject CEdgeBalanceWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CEdgeBalanceWidget.data,
      qt_meta_data_CEdgeBalanceWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CEdgeBalanceWidget.stringdata))
