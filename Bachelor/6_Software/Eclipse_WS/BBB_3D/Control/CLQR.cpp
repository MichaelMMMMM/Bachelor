...
//	Float32 torqueOffset = 0.008F * (input.mUKData.mUK_k1 + input.mUKData.mUK_k2 + input.mUKData.mUK_k3) / 1.7321F;
//
//	mOutput.mTorque1 += torqueOffset;
//	mOutput.mTorque2 += torqueOffset;
//	mOutput.mTorque3 += torqueOffset;
