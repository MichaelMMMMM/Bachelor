...
void CMPU9250::init()
{
	...
	assertion = this->writeRegister(sPWER_MGMT_1, 0x00U);
	sAssertion(assertion, "(CMPU9250::CMPU9250) Failed to configure the Power-Management", true);
...
bool CMPU9250::readSensorData(CMPUData& data)
{
	UInt8 tx_buf[] = { sACCEL_XOUT_H + 0x80U, sACCEL_XOUT_L + 0x80U,
					   ...
					   0U };
	UInt8 rx_buf[15] = { 1U, 1U, 1U, 1U, 1U };
