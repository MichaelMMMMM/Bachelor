%19.11.16, Michael Meindl, Auswertung Messreihe1, plottet Spektren der
%phi-Signal aus Accel und Gyro
...
for k = 1:12
    ...
    title(horzcat('\phi-Accel bei Frequenz ', freqName{k}, ' Hz, f_a=f_m=50Hz'));
